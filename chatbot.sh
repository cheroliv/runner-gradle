#!/usr/bin/env bash
# chatbot.sh — Engine N3 orchestrator, REPL conversationnelle
...
Bonjour, je suis l'orchestrateur N3. Prêt à t'aider avec l'architecture du workspace Engine."

display_banner() {
    echo "═════════════════════════════════════════════════"
    echo "  Engine N3 Orchestrator — ${MODEL}"
